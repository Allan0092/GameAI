...
# Load Qwen2-7B-Instruct with 8-bit quantization and CPU offloading
...
try:
    ...
    print("Ensure you have access to the model and bitsandbytes is installed.")
    exit(1)
...
def generate_dialogue(player_input: str, npc_context: str) -> str:
    """Generate NPC dialogue using Qwen2-7B-Instruct."""
    messages = [
